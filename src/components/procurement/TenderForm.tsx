    ...
    <div className="flex flex-col items-center gap-6 p-4">
      ...
      >
        ...
        <div className="flex xl:hidden gap-4 mb-6 no-print w-full justify-center">
          <button onClick={handlePrint} className="flex-1 bg-slate-900 text-white p-4 rounded-2xl flex items-center justify-center gap-2 font-black text-xs uppercase"><Printer size={16}/> Print</button>
