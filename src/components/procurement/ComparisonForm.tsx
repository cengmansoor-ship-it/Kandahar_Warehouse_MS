  ...
  return (
    <div className="flex flex-col items-center gap-6 p-4">
      ...
      <div 
        ref={componentRef}
        dir="rtl"
        className="relative a4-page font-sans text-slate-900 border border-slate-200 overflow-x-hidden"
      >
        ...
        <div className="absolute -right-20 top-0 hidden xl:flex flex-col gap-4 no-print">
          ...
          <button 
            onClick={addItem}
            title="Add Item"
            className="p-4 bg-white border border-slate-200 text-slate-400 rounded-2xl hover:bg-slate-50 transition-all shadow-xl hover:scale-110 active:scale-95"
          >
            <PlusCircle size={24} />
          </button>
        </div>
        ...
        <div className="flex xl:hidden gap-4 mb-6 no-print w-full justify-center">
          <button onClick={handlePrint} className="flex-1 bg-slate-900 text-white p-4 rounded-2xl flex items-center justify-center gap-2 font-black text-xs uppercase"><Printer size={16}/> Print Matrix</button>
